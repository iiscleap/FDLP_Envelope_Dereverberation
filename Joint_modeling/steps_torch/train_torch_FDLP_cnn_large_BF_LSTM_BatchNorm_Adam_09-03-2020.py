...
from datagen.dataGeneratorCNN_multiAll_LSTM_800X36_sliding_window_09_03_2020 import dataGeneratorCNN_multiAll
import numpy
import sys
...
from NET.Net_CNN_2LSTM_padding_64filters_last2_batch_one import Net1
...
class Train():
     ...
     def fit (self, net1, net2, trGen, cvGen,criterion,optimizer,epoch,totalepoch,flag, num):
        net1.train()
        net2.train()
...
for epoch in range(learning['minEpoch']):
 ...
 if epoch == 0:
     flag = True
 abc=train1.fit(net1 , net2, trGen, cvGen,criterion,optimizer,epoch,1,flag, num)
 num = num + 1
...
print ("finished training final model is = /dnn_nnet_ENV.model" + str(n))
print (" AND ASR Model is = /dnn_nnet_ASR.model"+ str(n))
