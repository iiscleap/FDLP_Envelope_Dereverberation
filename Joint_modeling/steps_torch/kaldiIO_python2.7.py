...
### for python 3 ###
    #ark.open (struct.pack('<%ds'%(len(uttId)),uttId.encode(encoding)),'wb')
    #ark.open (struct.pack('<cxcccc',' '.encode(encoding),'B'.encode(encoding),
    #            'F'.encode(encoding),'M'.encode(encoding),' '.encode(encoding)),'wb')
    #ark.open (struct.pack('<bi', 4, m),'wb')
    #ark.open (struct.pack('<bi', 4, n),'wb')
