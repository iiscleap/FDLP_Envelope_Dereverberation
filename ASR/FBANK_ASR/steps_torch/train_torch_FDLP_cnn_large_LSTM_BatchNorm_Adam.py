...
from dataGeneratorCNN_multiAll import dataGeneratorCNN_multiAll
import numpy
import sys
...
cvGen = dataGeneratorCNN_multiAll (data_cv, ali_cv, gmm, learning['batchSize'],learning['spliceSize'])
