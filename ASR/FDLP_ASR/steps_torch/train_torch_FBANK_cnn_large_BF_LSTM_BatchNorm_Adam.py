...
from dataGeneratorFBANKCNN  import  dataGeneratorFBANKCNN
import numpy
import sys
from Net_FBANK_LSTM_BatchNorm import Net
...
trGen = dataGeneratorFBANKCNN (data_tr, ali_tr, gmm, learning['batchSize'],learning['spliceSize'])
cvGen = dataGeneratorFBANKCNN (data_cv, ali_cv, gmm, learning['batchSize'],learning['spliceSize'])
...
#          print ('[%d,%5d] loss_cv: %.3f' % (epoch+1,j+1,running_loss_cv/cvGen.numSteps))
           ...
           print ('VALID ==> [%d,%5d] LOSS: %.3f  ACCURACY  : %.3f %%'%(epoch+1,j+1,running_loss_cv/cvGen.numSteps,100 * correct_cv / total_cv))
           running_loss_cv =0.0
